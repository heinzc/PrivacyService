...
#include </Users/kchand/Desktop/HME/homomorphic-enc/third-party/libhcs/include/libhcs.h> // master header includes everything
...
class phe_handler : he_handler
{
    ...
    private:
        ...
        hcs_random * hr = 0;
    pcs_public_key * pkey = 0;
    pcs_private_key * skey = 0;
